...
function llamarAhora(numero) {
    // Redirige al protocolo tel: para dispositivos móviles
    window.location.href = `tel:${numero}`;
    
    // Para dispositivos de escritorio podrías mostrar el número
    if (!/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)) {
        alert(`Este dispositivo no puede hacer llamadas. Número: ${numero}`);
    }
}